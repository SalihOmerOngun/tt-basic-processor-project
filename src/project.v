...
module tt_um_basic8 (
    ...
    always @(*) begin
        case (opcode)
            4'b0000: wdata = alu_out;
            4'b0001: wdata = rs1_val + imm8;
            4'b0010: wdata = rs1_val & {2'b00,imm6};
            4'b0011: wdata = rs1_val | {2'b00,imm6};
            4'b0100: wdata = rs1_val ^ {2'b00,imm6};
    ...
    wire [2:0] rd_sel = uio_in[4:2];
    assign uo_out  = pc;
    assign uio_out = regfile[rd_sel];
